...
Если вы не хотите устанавливать среду выполнения `.NET`, можете [загрузить](https://github.com/Lifailon/rpnet/releases/latest) zip-архив с версией **self-contained**, которая уже содержит в себе все зависимости (доступно для обеих платформ).
